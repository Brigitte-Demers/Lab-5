...
#define MAX_SPRITE_IMAGES 100 // Added to try to animate ship.
...
public:
	bool loaded;
	string imagename;
	int maximum_images; // Maximum ammount of images in spritesheet, added to try to animate ship.
	int current_image; // Current spritesheet image displayed, added to try to animate ship.
	int sheet_width; // Whole width of spritesheet, added to try to animate ship.
	int sheet_height; // Whole height of spritesheet, added to try to animate ship.
	SDL_Rect position;
	SDL_Rect velocity;
